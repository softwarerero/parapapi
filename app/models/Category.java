...
public class Category {
  ...
  public static final String[] service = {"healthservice", "workshop", "finance", "transportservice", "construction", "animation", "eventTechnology", "multimedia", "security", "tourism"};
  public static final String[] job = {"healthjob", "educationjob", "industry", "office", "householdjob"};
