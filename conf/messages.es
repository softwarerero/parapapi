...
Ad.title=Titulo
Ad.language=Idioma
Ad.offer=Typo de oferta
Ad.content=Texto
Ad.handOver=Typo de anuncio
Ad.price=Precio
Ad.phone=Teléfono
Ad.mobilePhone=Celular
Ad.email=Email
mainCategory=Categoria
Ad.priceType=Typo de precio
Ad.currency=Moneda
...
User.documentType=Typo de documento
User.Country=País
